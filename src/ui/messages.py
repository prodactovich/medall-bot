...
def patient_intro() -> str:
    return (
        "Я помогу вам разобраться в медицинских анализах и заключениях "
        "простым и понятным языком.\n\n"
        "Отправьте документ или текст, и вы сможете:\n\n"
        "• 📎 Понять, что означает результат\n"
        "• 🚨 Оценить, срочная ли ситуация\n"
        "• 🧭 Получить план действий на ближайшие сутки\n"
        "• 🗣️ Подготовить вопросы к врачу перед приёмом\n\n"
        "⚠️ Я не ставлю диагнозы и не заменяю врача, но помогу лучше "
