...
async def show_about(
    ...
    text = (
        "Я MedAll 🤖\n\n"
        "Я сочетаю современные технологии на базе искусственного "
        "интеллекта ✨ с задачей, которая действительно важна: делать "
        "медицинскую информацию понятной людям ❤️\n\n"
        "MedAll создан на стыке ИИ, медицины 🩺 и цифрового опыта 💡, "
        "чтобы помогать быстрее разбираться в анализах, заключениях, "
        "выписках и других медицинских документах без лишней перегрузки "
        "и сложного профессионального языка.\n\n"
        "Во мне соединяются:\n"
        "• современные AI-технологии 🤖\n"
        "• структурный разбор медицинской информации 📄\n"
        "• понятная подача сложных данных 🧠\n"
        "• внимание к безопасности формулировок ⚠️\n"
        "• помощь в подготовке к разговору с врачом 💬\n\n"
        "Моя цель - не просто показать текст документа другими словами, "
        "а помочь человеку почувствовать больше ясности, спокойствия и "
        "понимания в момент, когда это особенно нужно 🌿\n\n"
        "Для пациентов MedAll - это способ быстрее понять, что происходит "
        "🫶\n"
        "Для врачей - дополнительный инструмент понятной коммуникации "
        "👨‍⚕️\n"
        "Для студентов-медиков - удобная среда для погружения в "
        "медицинский язык и логику 🎓\n\n"
        "Я не заменяю врача и не ставлю диагноз.\n"
        "Я помогаю сделать сложную медицинскую информацию ближе, "
        "понятнее и человечнее 🤍\n\n"
        "Спасибо, что вы с MedAll 🤍\n\n"
        "Цель команды MedAll - делать мир чуточку лучше и здоровее, "
        "помогая людям понятнее видеть медицинскую информацию и "
        "чувствовать больше ясности в важные моменты."
    )
